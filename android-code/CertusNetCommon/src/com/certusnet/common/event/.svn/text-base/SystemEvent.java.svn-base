package com.certusnet.common.event;
...
public class SystemEvent{
	...
	protected static SparseArray<List<WeakReference<EventListener>>> mEventMap = new SparseArray<List<WeakReference<EventListener>>>();

	protected static SparseArray<List<WeakReference<PreEventListener>>> mPreEventMap = new SparseArray<List<WeakReference<PreEventListener>>>();
